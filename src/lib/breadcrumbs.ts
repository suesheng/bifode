...
const ROUTES: Record<string, RouteDef> = {
  ...
  '/projekte/ulpan-next': { labelDe: 'Ulpan Ivrit', labelEn: 'Ulpan Ivrit' },
  '/en/projects/ulpan-next': { labelDe: 'Ulpan Ivrit', labelEn: 'Ulpan Ivrit' },
  '/en/ulpan': { labelDe: 'Ulpan Ivrit', labelEn: 'Ulpan Ivrit' },
  '/en/membership': { labelDe: 'Mitgliedschaft', labelEn: 'Membership' },
  ...
  '/charta': { labelDe: 'Charta', labelEn: 'Charter' },
  '/en/charter': { labelDe: 'Charta', labelEn: 'Charter' },
  '/werte': { labelDe: 'Unsere Werte', labelEn: 'Our Values' },
  '/en/values': { labelDe: 'Unsere Werte', labelEn: 'Our Values' },
